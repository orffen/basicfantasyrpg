 ...
 */
export class SimpleMonsterSheet extends HandlebarsApplicationMixin(ActorSheetV2) {

    /** @override */
    static DEFAULT_OPTIONS = {
        classes: ["basicfantasyrpg", "sheet", "actor", "simple", "monster"],
        position: {
            width: 400,
            height: 600
        },
        window: {
            resizable: true,
            title: "Monster groaar!"
        },
        form: {
            handler: SimpleMonsterSheet.#onSubmitDocumentForm,
            submitOnChange: true
        }
    };
    ...
    static PARTS = {
        header: {
            template: "systems/basicfantasyrpg/templates/actor/simple-monster-sheet.hbs"
        }
    };
    ...
    _onRender(context, options) {
        ...
        console.log("Simple Monster Sheet rendered for:", context.name);
    }
